...
export const TESTIMONIALS = [
  {
    name: 'Markus B.',
    role: 'Familie, München',
    text: 'Superschnelle Lieferung, Top-Qualität. Der ERIBA Touring ist genau wie beschrieben – absolut empfehlenswert!',
    rating: 5,
  },
  {
    name: 'Sandra K.',
    role: 'Reisende, Hamburg',
    text: 'Toller Service! Hatte eine Frage zum Sterckeman 480CP – wurde sofort und kompetent beantwortet. Kauf war reibungslos.',
    rating: 5,
  },
  {
    name: 'Peter W.',
    role: 'Camper, Bayern',
    text: 'Preis-Leistung unschlagbar. Caravelair Alba für unsere Familie – deutlich günstiger als beim Händler und bessere Qualität.',
    rating: 5,
  },
];
