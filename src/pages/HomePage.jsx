  ...
  return (
    <main>
      ...
      <section style={{
        ...
        {/* Scroll indicator */}
        <div style={{ position: 'absolute', bottom: 24, left: 0, right: 0, zIndex: 2, display: 'flex', justifyContent: 'center' }}>
          <div style={{
            ...
            <i className="bi bi-chevron-down" style={{ fontSize: isMobile ? 12 : 16, color: 'white' }} />
          </div>
        </div>
      </section>
